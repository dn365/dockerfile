...
** 修改mritd/v2ray 版本中 自定义config 服务无法启动问题 **
...
``` sh
docker run --rm dn365/v2ray "cat /etc/v2ray/config.json" > config.json
```
